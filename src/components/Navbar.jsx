...
const NavBar = () => {
  ...
  return (
    <div className="relative z-10 w-full bg-[#22485e]">
      ...
      <div
        className={`${
          nav
            ? "sm:hidden absolute top-0 right-0 left-0 bottom-0 flex justify-center items-center  w-full h-screen dark:bg-gray-900 text-black text-center duration-300 ease-in-out"
            : "hidden"
        } md:hidden`}
      >
        ...
        <ul
          onClick={toggleNav}
          className="flex flex-col text-2xl gap-8 items-center"
        >
          <Link to="/"
            className="hover:text-[#FF0000] transition-all ease-in-out duration-500 cursor-pointer"
          >
