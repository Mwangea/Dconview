  ...
  return (
    <div className='w-[100%] z-10  bg-[#22485e]'>
      ...
      <p className="bg-[rgb(146,122,122)] h-[1px] w-[100%]" />
       <div className="py-6 my-1 md:w-[80%] w-[95%]  flex justify-between items-center mx-auto space-x-7">
        <Link 
        to="/"
       ...
       <div 
         className={
          nav ? "sm:hidden absolute top-0 right-0 left-0 bottom-0 flex justify-center items-center w-full h-screen bg-white text-black text-center duration-300 ease-in-out"
